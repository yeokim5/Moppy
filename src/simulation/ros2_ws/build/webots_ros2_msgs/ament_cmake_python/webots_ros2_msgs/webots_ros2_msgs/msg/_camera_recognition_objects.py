...
class Metaclass_CameraRecognitionObjects(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if CameraRecognitionObject.__class__._TYPE_SUPPORT is None:
                CameraRecognitionObject.__class__.__import_type_support__()
...
class CameraRecognitionObjects(metaclass=Metaclass_CameraRecognitionObjects):
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'objects' field must be a set or sequence and each value of type 'CameraRecognitionObject'"
        self._objects = value
