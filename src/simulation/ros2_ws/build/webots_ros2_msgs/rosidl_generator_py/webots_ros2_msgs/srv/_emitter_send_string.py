...
class Metaclass_EmitterSendString_Request(type):
...
class EmitterSendString_Request(metaclass=Metaclass_EmitterSendString_Request):
...
class Metaclass_EmitterSendString_Response(type):
...
class EmitterSendString_Response(metaclass=Metaclass_EmitterSendString_Response):
...
class Metaclass_EmitterSendString(type):
...
class EmitterSendString(metaclass=Metaclass_EmitterSendString):
    from webots_ros2_msgs.srv._emitter_send_string import EmitterSendString_Request as Request
    from webots_ros2_msgs.srv._emitter_send_string import EmitterSendString_Response as Response
