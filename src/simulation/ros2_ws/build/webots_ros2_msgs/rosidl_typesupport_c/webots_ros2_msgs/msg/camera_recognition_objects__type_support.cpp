...
static const _CameraRecognitionObjects_type_support_symbol_names_t _CameraRecognitionObjects_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_ros2_msgs, msg, CameraRecognitionObjects)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, msg, CameraRecognitionObjects)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, webots_ros2_msgs, msg, CameraRecognitionObjects)() {
  return &::webots_ros2_msgs::msg::rosidl_typesupport_c::CameraRecognitionObjects_message_type_support_handle;
}
