...
static const _EmitterSendString_Request_type_support_symbol_names_t _EmitterSendString_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_ros2_msgs, srv, EmitterSendString_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, EmitterSendString_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, webots_ros2_msgs, srv, EmitterSendString_Request)() {
  return &::webots_ros2_msgs::srv::rosidl_typesupport_c::EmitterSendString_Request_message_type_support_handle;
}
...
static const _EmitterSendString_Response_type_support_symbol_names_t _EmitterSendString_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_ros2_msgs, srv, EmitterSendString_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, EmitterSendString_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, webots_ros2_msgs, srv, EmitterSendString_Response)() {
  return &::webots_ros2_msgs::srv::rosidl_typesupport_c::EmitterSendString_Response_message_type_support_handle;
}
...
static const _EmitterSendString_type_support_symbol_names_t _EmitterSendString_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webots_ros2_msgs, srv, EmitterSendString)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, EmitterSendString)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, webots_ros2_msgs, srv, EmitterSendString)() {
  return &::webots_ros2_msgs::srv::rosidl_typesupport_c::EmitterSendString_service_type_support_handle;
}
