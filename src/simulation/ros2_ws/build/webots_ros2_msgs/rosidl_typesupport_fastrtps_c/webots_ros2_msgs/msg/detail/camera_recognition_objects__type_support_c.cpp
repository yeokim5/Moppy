  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, webots_ros2_msgs, msg, CameraRecognitionObject
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _CameraRecognitionObjects__ros_msg_type * ros_message = static_cast<_CameraRecognitionObjects__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
